    ...
    <div className="p-10">
      ...
      <div className="grid md:grid-cols-3 p-5 md:p-10">
        <div className="pb-3 md:p-10">
          <h5 className="font-semibold text-2xl">Full Truckload</h5>
        ...
        <div className="pb-3 md:p-10">
          <h5 className="font-semibold text-2xl">Less Than Truckload</h5>
          <div className="flex mb-5">
            <hr className=" mt-3 w-1/3 bg-[#00ff00] border-2 border-[#00ff00]" />
            <hr className=" mt-3 w-1/5 bg-black border-2 border-black" />
          </div>
        ...
        <div className="pb-3 md:p-10">
          <h5 className="font-semibold text-2xl">Final Mile</h5>
          <div className="flex mb-5">
            <hr className=" mt-3 w-1/3 bg-[#00ff00] border-2 border-[#00ff00]" />
            <hr className=" mt-3 w-1/5 bg-black border-2 border-black" />
          </div>
        ...
        <div className="pb-3 md:p-10">
          <h5 className="font-semibold text-2xl">Drayage</h5>
          <div className="flex mb-5">
            <hr className=" mt-3 w-1/3 bg-[#00ff00] border-2 border-[#00ff00]" />
            <hr className=" mt-3 w-1/5 bg-black border-2 border-black" />
          </div>
        ...
        <div className="pb-3 md:p-10">
          <h5 className="font-semibold text-2xl">Warehousing solutions</h5>
          <div className="flex mb-5">
            <hr className=" mt-3 w-1/3 bg-[#00ff00] border-2 border-[#00ff00]" />
            <hr className=" mt-3 w-1/5 bg-black border-2 border-black" />
          </div>
